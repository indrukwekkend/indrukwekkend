                        ...
                        <div class="row">
                                ...
                                <span><?php the_field('landline'); ?></span>
                    						...
                    						<?php if( get_field('mobile') ):?>
                    							...
                    							<div class="col p-0">
                                <div class="case-icon mobile"></div>
                                <span><?php the_field('mobile'); ?></span>
                    						...
                    						<?php if( get_field('strava') ):?>
                    							...
                    							<div class="col p-0">
                                <div class="case-icon strava"></div>
    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-3 text-right pr-5">
                <span class="case-related-title"> Bekijk de<br> andere cases
                </span>
            </div>
